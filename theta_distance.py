...
def vincenty_inverse(lat1, lon1, lat2, lon2, ellipsoid=None):
    ...
    return s,degrees(α1),degrees(α2)
...
# y2=int(input())
# 
# point1 = GPS_return(x1,y1)

# point2 = GPS_return(x2,y2)
#result = vincenty_inverse(point1['lat'], point1['long'], point2['lat'], point2['long'], 1)
