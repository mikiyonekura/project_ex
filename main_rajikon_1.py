...
while notEndnode:
    if(flag_for==1):
        for i in short:
            ...
            while notNextnode:
                ard_state = i2c.read_byte(addr)
                print('--while1_ard_state--:',ard_state)
                if(ard_state == 3):
                    short,dis_flag = route_search(bef_node,aft_node)
                    flag_for=2
                    print("--flag_for:--",flag_for)
                    print("--reroute_short--",short)
            ...
            print('--for1_ard_state--:',ard_state)
            if(ard_state == 3):
                print('flag_for2へ移行します')
                break
    ...
    if(flag_for==2):
        for i in short:
            ...
            while notNextnode:
                ard_state = i2c.read_byte(addr)
                print('--while2_ard_state--:',ard_state)
                if(ard_state == 3):
                    short,dis_flag = route_search(bef_node,aft_node)
                    flag_for=2
                    print("--flag_for:--",flag_for)
            ...
            print('--for2_ard_state--:',ard_state)
            if(ard_state == 3):
